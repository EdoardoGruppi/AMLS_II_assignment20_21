...
# Build model object.
model_A = A(input_shape, loss=loss)
...
train_batches, valid_batches, test_batches = prepare_batches(crop_size=patch_size, batch_size=batch_dim,
                                                             task='A', rotation=True, flip=True, scale=scale)
# Change model object.
model_A.new_scale(scale=scale, loss=loss)
# Train model based on the training set (you should fine-tune your model based on validation set).
results_A3.append(model_A.train(train_batches, valid_batches, epochs=30, verbose=2))
# Test model based on the test set.
...
model_A.new_scale(scale=scale, loss=loss)
# Train model based on the training set (you should fine-tune your model based on validation set).
results_A4.append(model_A.train(train_batches, valid_batches, epochs=30, verbose=2))
# Test model based on the test set.
...
# Build model object.
model_B = B(input_shape, loss=loss, scale=scale)
# Train model based on the training set (you should fine-tune your model based on validation set).
...
train_batches, valid_batches, test_batches = prepare_batches(crop_size=patch_size, batch_size=batch_dim,
                                                             task='B', rotation=True, flip=True, scale=scale)
# Change model object.
model_B.new_scale(input_shape=input_shape, scale=scale, loss=loss)
# Train model based on the training set (you should fine-tune your model based on validation set).
results_B3.append(model_B.train(train_batches, valid_batches, epochs=30))
# Test model based on the test set.
...
model_B.new_scale(input_shape=input_shape, scale=scale, loss=loss)
# Train model based on the training set (you should fine-tune your model based on validation set).
results_B4.append(model_B.train(train_batches, valid_batches, epochs=30))
# Test model based on the test set.
